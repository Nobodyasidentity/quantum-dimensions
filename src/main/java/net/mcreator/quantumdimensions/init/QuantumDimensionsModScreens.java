...
import net.mcreator.quantumdimensions.client.gui.QuantumMachineGUIScreen;
...
public class QuantumDimensionsModScreens {
	public static void clientLoad() {
		MenuScreens.register(QuantumDimensionsModMenus.QUANTUM_MACHINE_GUI, QuantumMachineGUIScreen::new);
	}
