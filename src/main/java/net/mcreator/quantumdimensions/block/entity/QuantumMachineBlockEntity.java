...
public class QuantumMachineBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(9, ItemStack.EMPTY);

	public QuantumMachineBlockEntity(BlockPos position, BlockState state) {
	...
	public Component getDefaultName() {
		return Component.literal("quantum_machine");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new QuantumMachineGUIMenu(id, inventory, this, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return Component.literal("Quantum Machine");
	}
